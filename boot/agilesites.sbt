...
javacOptions ++= Seq("-proc:none", "-s", s"${(javaSource in Compile).value.getAbsolutePath}", "-g", "-Xlint:unchecked") //, "-J-Xdebug", "-J-Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5006")
