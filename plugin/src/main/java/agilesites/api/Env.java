...
public interface Env extends Content {
	 ...
	 * @return a picker where place content
	 */
	public abstract Picker pick(String template);

	/**
	 * @param template the template to use
	 * @param cssq  a css query to select a subset
	 * @return a picker where place content
	 */
	public abstract Picker pick(String template, String cssq);
