...
//+import COM.FutureTense.Util.ftErrors as AaaFtErrors
import COM.FutureTense.Util.ftErrors; //-


@SuppressWarnings("deprecation")
public class AAAgileICSProxy implements ICS {
    ...
    public int getVersionMajorMinor() {
        return 1;
    }

    public int getVersionMajorLevel() {
        return 4;
    }
    ...
    public AAAgileICSProxy() {
    }

    public AAAgileICSProxy(ICS ics) {
        init(ics);
    }
...
//+  public AaaFtErrors getComplexError() {
...
//+  public void setComplexError(AaaFtErrors arg0) {
