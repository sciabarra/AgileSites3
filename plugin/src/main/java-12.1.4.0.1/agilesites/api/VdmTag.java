...
public static Mergeinactive mergeinactive() {
  ...
  public static class Getanonymousdata {
  private FTValList args = new FTValList();
  private String output;
  public Getanonymousdata set(String name, String value) { args.setValString(name,value); return this; }
 public Getanonymousdata attribute(String val) { args.setValString("ATTRIBUTE", val); return this; }
      
 public Getanonymousdata namespace(String val) { args.setValString("NAMESPACE", val); return this; }
      
 public Getanonymousdata key(String val) { args.setValString("KEY", val); return this; }
      
 public Getanonymousdata value(String val) { args.setValString("VALUE", val); return this; }
      
 public Getanonymousdata varname(String val) { args.setValString("VARNAME", val); return this; }
      
  public Getanonymousdata() { }
  public int run(ICS ics) {
      ics.runTag("VDM.GETANONYMOUSDATA", args);
      log.trace(ftValList2String("Getanonymousdata", args));
      return ics.GetErrno();
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Getanonymousdata set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Getanonymousdata getanonymousdata() {
  return new Getanonymousdata();
}
