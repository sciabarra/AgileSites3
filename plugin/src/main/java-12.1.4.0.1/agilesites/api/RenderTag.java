...
public static Satellitepage satellitepage() {
 ...
 public Satelliteblob optimize(String val) { args.setValString("OPTIMIZE", val); return this; }
...
public static Getpageurl getpageurl() {
 ...
 public Getbloburl optimize(String val) { args.setValString("OPTIMIZE", val); return this; }
