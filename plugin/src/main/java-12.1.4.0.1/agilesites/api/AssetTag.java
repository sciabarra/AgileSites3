...
public static Gettemplaterootelement gettemplaterootelement() {
  ...
  public static class Def_ {
  private FTValList args = new FTValList();
  private String output;
  public Def_ set(String name, String value) { args.setValString(name,value); return this; }
 public Def_ list(String val) { args.setValString("LIST", val); return this; }
      
 public Def_ type(String val) { args.setValString("TYPE", val); return this; }
      
 public Def_ subtype(String val) { args.setValString("SUBTYPE", val); return this; }
      
 public Def_ pubid(String val) { args.setValString("PUBID", val); return this; }
      
  public Def_() { }
  public int run(ICS ics) {
      ics.runTag("ASSET.DEF_", args);
      log.trace(ftValList2String("Def_", args));
      return ics.GetErrno();
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
