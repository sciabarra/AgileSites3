...
public static Encode encode() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Getdiff set(String name, String value) { args.setValString(name,value); return this; }
 public Getdiff varname(String val) { args.setValString("VARNAME", val); return this; }
      
 public Getdiff value1(String val) { args.setValString("VALUE1", val); return this; }
      
 public Getdiff value2(String val) { args.setValString("VALUE2", val); return this; }
      
 public Getdiff list1(String val) { args.setValString("LIST1", val); return this; }
      
 public Getdiff list2(String val) { args.setValString("LIST2", val); return this; }
      
  public Getdiff() { }
  public int run(ICS ics) {
      ics.runTag("STRING.GETDIFF", args);
      log.trace(ftValList2String("Getdiff", args));
      return ics.GetErrno();
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
