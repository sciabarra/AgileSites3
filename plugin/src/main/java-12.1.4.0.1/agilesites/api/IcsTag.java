...
public static Queryevents queryevents() {
 ...
 public Literal string_(String val) { args.setValString("STRING", val); return this; }
...
public static Literal literal() {
 ...
 public Sqlexp string_(String val) { args.setValString("STRING", val); return this; }
...
public static Ifnotempty ifnotempty() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Ifequals set(String name, String value) { args.setValString(name,value); return this; }
 public Ifequals variable(String val) { args.setValString("VARIABLE", val); return this; }
      
 public Ifequals value(String val) { args.setValString("VALUE", val); return this; }
      
  public Ifequals() { }
  public int run(ICS ics) {
      ics.runTag("ICS.IFEQUALS", args);
      log.trace(ftValList2String("Ifequals", args));
      return ics.GetErrno();
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
...
public static Ifequals ifequals() {
  return new Ifequals();
}


  public static class Ifnotequals {
  private FTValList args = new FTValList();
  private String output;
  public Ifnotequals set(String name, String value) { args.setValString(name,value); return this; }
 public Ifnotequals variable(String val) { args.setValString("VARIABLE", val); return this; }
      
 public Ifnotequals value(String val) { args.setValString("VALUE", val); return this; }
      
  public Ifnotequals() { }
  public int run(ICS ics) {
      ics.runTag("ICS.IFNOTEQUALS", args);
      log.trace(ftValList2String("Ifnotequals", args));
      return ics.GetErrno();
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Ifnotequals set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Ifnotequals ifnotequals() {
  return new Ifnotequals();
}


  public static class Ifenabled {
  private FTValList args = new FTValList();
  private String output;
  public Ifenabled set(String name, String value) { args.setValString(name,value); return this; }
 public Ifenabled fieldname(String val) { args.setValString("FIELDNAME", val); return this; }
      
  public Ifenabled() { }
  public int run(ICS ics) {
      ics.runTag("ICS.IFENABLED", args);
      log.trace(ftValList2String("Ifenabled", args));
      return ics.GetErrno();
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Ifenabled set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Ifenabled ifenabled() {
