val agilesitesVersion = settingKey[String]("agilesitesVersion")

agilesitesVersion := scala.io.Source.fromFile("agilesites.ver").
...
unmanagedBase := {
  ...
  if (!dist.exists) {
    ...
    println("- deploy you base site with asDeploy")
  }
  dist
}
...
libraryDependencies ++= Seq(
  "com.sciabarra" % "agilesites3-plugin" % agilesitesVersion.value
    extra("scalaVersion" -> "2.10", "sbtVersion" -> "0.13")
  , "com.sciabarra" % "agilesites3-plugin" % agilesitesVersion.value % "tomcat"
    extra("scalaVersion" -> "2.10", "sbtVersion" -> "0.13")
  , "com.sciabarra" % "agilesites3-core" % agilesitesVersion.value % "core" intransitive()
  , "com.sciabarra" % "agilesites3-core" % agilesitesVersion.value
  , "com.sciabarra" % "agilesites3-api"  % agilesitesVersion.value % "api" intransitive()
  ...
  , "com.sciabarra" % "agilesites3-api" % agilesitesVersion.value
